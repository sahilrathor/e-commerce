...
const ProductDetails: React.FC = () => {
    ...
    useEffect(() => {
        const data = items.filter((item) => item.category.includes(itemInfo?.category[0] || ''))
            ...
            <div className="container pt-8 max-w-screen-xl mx-auto">
                <div className='w-full h-full bg-white p-8 flex gap-8 rounded-xl'>
                    ...
                    <div className='absolute top-5 right-5 flex  gap-2'>
                        ...
                        <button className='w-8 h-8 border border-gray-200 flex items-center justify-center rounded-lg text-gray-500 hover:bg-gray-200 hover:text-gray-600 transition-all duration-150 group'>
